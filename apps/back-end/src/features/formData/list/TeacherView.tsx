...
import { useTeacherFormDatasListData } from '../hook/useTeacherFormDatasListData ';
import { FormDataActionsDropDown } from '../common';
import { Button } from 'react-bootstrap';

const TeacherFormDataView = () => {
  const {
    paginator,
    loadingStatus,
    error,
...
export default TeacherFormDataView;
